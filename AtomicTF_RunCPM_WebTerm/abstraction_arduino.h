...
//extern void led_show(CRGB color);
//#define COLOR_ON CRGB::Orange
//#define COLOR_OFF CRGB::Blue
...
//  return(Serial.read());
  while (!uxQueueMessagesWaiting(xQueue))loop();
  uint8 ch;
...
//  Serial.println("\e[H\e[J");
  webSocket.sendTXT(WS_num, "\e[H\e[J");
}
